# Form implementation generated from reading ui file 'Tela_produtosLocalização.ui'
#
...
class Ui_MainWindow(object):
    ...
    def adicionaBanco(self):
        ...
        self.preco = self.precovenda.text()
    ...
    def localizaProduto(self):
        ...
        try:
            ...
            #Insere dados na tabela
            cursor.execute("SELECT * FROM produtos WHERE upper(descricao) LIKE upper('%s')"  %(desc) ) # Lê os dados
